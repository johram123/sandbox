...
function recalculate() { 
    ...
    if (modelName.innerText == "Model XYZ") {
        totalCost = parseFloat(duration.innerText) * 100; 
    } 
    else if (modelName.innerText == "Model CPRG") { 
        totalCost = parseFloat(duration.innerText) * 213;
    }
...
function changeDuration() {
    let newDuration = parseFloat(prompt("How long is your duration?"));
